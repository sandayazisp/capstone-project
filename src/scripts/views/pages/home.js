    ...
    return `
        <div id="content-hero">
            ...
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div
                    class="container position-absolute top-50 start-50 translate-middle bg-dark bg-opacity-50 p-3 text-white d-flex align-items-center justify-content-center flex-column">
                    ...
                    <a class="btn btn-outline-warning" href="#/requirement" role="button">Peraturan </a>
                </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                          ...
                          <source media="(max-width: 900px)" srcset="./images/hero-1-large.jpg">
                          <img 
                              src="./images/hero-1-xl.jpg" 
                              alt="Melasti Beach" class="d-block"></img>
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                          <source media="(max-width: 600px)" srcset="./images/hero-2-small.jpg">
                          <source media="(max-width: 600px)" srcset="./images/hero-2-large.jpg">
                          <img 
                              src="./images/hero-2-xl.jpg" 
                              alt="GWK Bali" class="d-block"></img>
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                          <source media="(max-width: 600px)" srcset="./images/hero-3-small.jpg">
                          <source media="(max-width: 600px)" srcset="./images/hero-3-large.jpg">
                          <img 
                              src="./images/hero-3-xl.jpg" 
                              alt="Nusa Penida" class="d-block"></img>
        ...
        <div id="mainContent">
            <div class="container pt-5" id="about__bali">
                <h1 class="text-center pt-2 pb-5">Tentang Bali</h1>
                <div class="row row-cols-1 row-cols-md-2">
                    <div class="col">                                              
                        <picture>
                          <source media="(max-width: 600px)" srcset="./images/gwk-small.jpg">
                          <source media="(max-width: 1024px)" srcset="./images/gwk-large.jpg">
                          <img src="./images/gwk-xl.jpg" class="img-thumbnail w-100 h-75" alt="Patung GWK">
            ...
            <div id="rek__wisata" class="pt-5 pb-5">
                <div class="container">
                    <h1 class="text-center pb-5 text-white">Rekomendasi Objek Wisata</h1>
            ...
            <div id="rek__guidetour">
                <div class="parallax">
                    <div class="container p-5">
                        <h1 class="text-center pb-5 text-white">Pemandu Wisata</h1>
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 pb-5 border-bottom guideToure">
                                                     
                        </div>
                        <h2 class="text-center text-white pt-3 pb-3">Hubungi Admin</h2>
                        <h3 class="text-center text-white pb-3">Untuk Mendapatkan Pemandu Wisata yang Baik dan Profesional</h3>                                                                                                                  
                        ...
                        <div class="col-md-4 col-lg-3 shadow">
                          <div class="card text-center border-0 shadow-none">
                            <div class="card-body">
                              ...
                              <img src="mind_map.svg" class="card-img w-50 h-50 pt-3 pb-3" alt="Jaringan Luas">
                        ...
                        <div class="col-md-4 col-lg-3 shadow">
                          <div class="card text-center border-0 shadow-none">
                            <div class="card-body">
                              ...
                              <img src="handshake.svg" class="card-img w-50 h-50 pt-3 pb-3" alt="Profesional">
                        ...
                        <div class="col-md-4 col-lg-3 shadow">
                          <div class="card text-center border-0 shadow-none">
                            <div class="card-body">
                              ...
                              <img src="money_transfer.svg" class="card-img w-50 h-50 pt-3 pb-3" alt="Ativitas & Kreasi">
